		<div id="blog_wrapper">
			...
			<div id="blog_content">
				...
				<div class="blog_item">
					...
					<h2><a href="blog_post.php?layout=blog" title="Lorem ipsum dolor sit amet, consectetur adipis.">Lorem ipsum dolor sit amet, consectetur adipi</a></h2>
					...
					<p>Mauris cursus mi ut mi consectetur quis aliquet enim scelerisque. Etiam sed mi sapien. Nam et turpis eu dui aliquet pellentesque vel nec nibh. Ut dolor mauris, placerat vel tincidunt vel, commodo id ligula. Quisque tincidunt gravida elementum. Curabitur nisl augue, gravida ut accumsan ac, ullamcorper eget tortor. Sed egestas, metus quis interdum pellentesque, eros arcu molestie risus, sit amet gravida magna risus vitae magna. Quisque tempus sagittis aliquet.<br />
					<br />
					Praesent mi neque, sodales a tempor dignissim, rhoncus eget nisl. Nullam nec ante nec mauris suscipit commodo non sed nisi. Maecenas viverra tempus massa in pharetra. Duis aliquet faucibus augue at lacinia. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse dapibus elit quis est facilisis adipiscing. Aliquam erat volutpat. <a href="blog_post.php?layout=blog" title="Read more">Read more &rsaquo;</a></p>

					<div class="footer"><a href="blog_post.php?layout=blog#comments" title="Comments">Comments (3)</a> | <a href="blog_post.php?layout=blog" title="Permalink">Permalink</a></div>
					
				</div>
				
				<div class="blog_item">
					
					<h2><a href="blog_post.php?layout=blog" title="Nunc a mi adipiscing arcu cursus tincidunt">Nunc a mi adipiscing arcu cursus tincidunt</a></h2>
					
					<div class="info"><div class="tags">Categories: <a href="#" title="Category: blog">blog</a>, <a href="#" title="Category: website">website</a>, <a href="#" title="Category: template">template</a></div> Friday, Dec 23, 2011 by <strong>Subpixel</strong></div>

					<p><img src="images/image-small.jpg" width="250" height="200" alt="Decoration image"/>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque convallis pretium nulla non ullamcorper. Donec porta enim a urna tincidunt non mattis purus consectetur. Nulla hendrerit nisi in nisl viverra aliquet. Etiam nisi velit, mollis id pretium vel, semper tristique nibh. Proin ligula tortor, sagittis varius mollis ut, convallis et nibh. Cras pharetra gravida metus, viverra pulvinar dolor dictum id.<br />
					<br />
					Nunc a mi adipiscing arcu cursus tincidunt. Aenean lorem velit, interdum id ultricies sed, adipiscing vitae nulla. Nunc molestie commodo tempus. Integer luctus ornare mauris interdum interdum. Sed suscipit leo a orci venenatis eget lobortis ante varius. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum egestas ultricies laoreet. Nunc non purus in. <a href="blog_post.php?layout=blog" title="Read more">Read more &rsaquo;</a></p>
				...
				<div class="blog_item">
					...
					<p>Mauris cursus mi ut mi consectetur quis aliquet enim scelerisque. Etiam sed mi sapien. Nam et turpis eu dui aliquet pellentesque vel nec nibh. Ut dolor mauris, placerat vel tincidunt vel, commodo id ligula. Quisque tincidunt gravida elementum. Curabitur nisl augue, gravida ut accumsan ac, ullamcorper eget tortor. Sed egestas, metus quis interdum pellentesque, eros arcu molestie risus, sit amet gravida magna risus vitae magna. Quisque tempus sagittis aliquet.<br />
					<br />
					Praesent mi neque, sodales a tempor dignissim, rhoncus eget nisl. Nullam nec ante nec mauris suscipit commodo non sed nisi. Maecenas viverra tempus massa in pharetra. Duis aliquet faucibus augue at lacinia. Lorem ipsum dolor sit amet, consectetur adipiscing elit.  <a href="blog_post.php?layout=blog" title="Read more">Read more &rsaquo;</a></p>
				...
				<ul id="pagination">
					<li><a href="blog.php?layout=blog" title="Previous page">&lsaquo; Previous page</a></li>
					<li><a href="blog.php?layout=blog" title="Page 3">3</a></li>
					<li><a href="blog.php?layout=blog" title="Page 4">4</a></li>
					<li><em>5</em></li>
					<li><a href="blog.php?layout=blog" title="Page 6">6</a></li>
					<li><a href="blog.php?layout=blog" title="Page 7">7</a></li>
					<li><a href="blog.php?layout=blog" title="Next page">Next page &rsaquo;</a></li>
				</ul>
